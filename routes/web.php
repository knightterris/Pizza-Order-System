...
Route::middleware(['auth'])->group(function () {
    ...
    //first way to protect with middleware
    // Route::group(['middleware'=>'admin_auth'],function(){

    // });
    //secondway to protect with middleware
    Route::middleware(['admin_auth'])->group(function(){
    //admin
    //category
        ...
        Route::prefix('admin')->group(function(){
            ...
            Route::get('changeUser/changeRole',[AdminController::class,'changeAdminRole'])->name('admin#changeAdminRole');
        ...
        Route::prefix('user')->group(function(){
            ...
            Route::get('change/role',[UserController::class,'userChangeRole'])->name('ajax#userChangeRole');
            Route::get('read/{id}',[UserController::class,'readPage'])->name('admin#readPage');
            Route::get('deleteMessage/{id}',[UserController::class,'deleteMessage'])->name('admin#deleteMessage');
            Route::get('delete/all',[UserController::class,'deleteAll'])->name('admin#deleteAll');
        });
    });
    ...
    Route::group(['prefix'=>'user','middleware'=>'user_auth'],function(){
        ...
        Route::prefix('account')->group(function(){
                ...
                Route::post('change/{id}',[UserController::class,'accountChange'])->name('user#accoutChange');
