    ...
    <div class="container-fluid pb-5">
        <div class="row px-xl-5">
            <a href="{{ route('user#home') }}" class="text-decoration-none">
                <i class="fa-solid fa-backward d-flex ms-3 mt-3 fs-2 my-5 text-dark text-decoration-none"></i>
            </a>
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <div class="d-flex mb-3">
                        ...
                        <small class="pt-1">{{ $pizza->view_count + 1 }} <i class="fa-solid fa-eye ms-3"></i> </small>
                    </div>
                            ...
                            <div class="product-img position-relative overflow-hidden">
                                ...
                                <div class="product-action">
                                    ...
                                    <a class="btn btn-outline-dark btn-square"
                                        href="{{ route('user#pizzaDetails', $p->id) }}"><i class="fa-solid fa-info"></i></a>
                                </div>
                            </div>
