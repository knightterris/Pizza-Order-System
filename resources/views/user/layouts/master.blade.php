                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            ...
                            <div class="dropdown d-inline me-5">
                                <a class="btn btn-secondary dropdown-toggle" href="#" role="button"
                                    ...
                                    <i class="fa-regular fa-user me-3"></i>{{ Auth::user()->name }}
                                </a>

                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="{{ route('user#accountChangePage') }}"><i
                                                class="fa-solid fa-user me-3 my-3"></i>Account</a></li>
                                    <li><a class="dropdown-item" href="{{ route('user#changePasswordPage') }}"><i
                                                class="fa-solid fa-key me-3 my-3"></i>Change
                                            Password</a></li>
                                    <li><span class="dropdown-item">
                                            <form action="{{ route('logout') }}" method="post" class="d-inline">
                                                @csrf
                                                <button class="btn btn-outline-dark rounded-pill" type="submit">Logout
                                                    <i class="fa-solid fa-right-from-bracket ms-3"></i></button>
                                            </form>
                                        </span></li>
                                </ul>
                            </div>
